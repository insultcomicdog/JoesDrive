...
#define DRIVE_ADDRESS   4
  ...
  Adafruit_NeoPixel sLOGIC = Adafruit_NeoPixel(2, sLogicPIN, NEO_GRB + NEO_KHZ800); 
  Adafruit_NeoPixel lLOGIC = Adafruit_NeoPixel(4, lLogicPIN, NEO_GRB + NEO_KHZ800); 
  Adafruit_NeoPixel HP = Adafruit_NeoPixel(1, hpPIN, NEO_GRB + NEO_KHZ800); 
